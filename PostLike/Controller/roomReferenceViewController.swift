...
class RoomRefernceViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        enteredVC.passedTitle = passedFollwedRoomArray[indexPath.row].roomName
        enteredVC.passedDocumentID = passedFollwedRoomArray[indexPath.row].documentID
        enteredVC.passedProfileImage = passedFollwedRoomArray[indexPath.row].userImage
        enteredVC.passedUserName = passedFollwedRoomArray[indexPath.row].userName
        enteredVC.passedModerator = passedFollwedRoomArray[indexPath.row].moderator
