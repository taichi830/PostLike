...
/**
 UIImage type for memory cache cost.
 */
...
/**
 ...
 @note Note that because of the limitations of type this property can get out of sync if you create another instance with CGImage or other methods.
